...
def main():
    ...
    parser.add_argument('--augment_type_for_short', type=str, default='SIMRCP',
                        help="data augmentation types for short sequences. Chosen from: \
                        SI, SIM, SIR, SIC, SIMR, SIMC, SIRC, SIMRC, SIMRCP.")
    parser.add_argument("--pooling_rate", type=float, default=0.5, help="pooling ratio for pooling operator")
    ...
    parser.add_argument('--pooling_mode', default='maximum', type=str,
                        help="minimum or maximum")
    ...
    # model args
    parser.add_argument("--model_name", default='DCLT4Rec', type=str)
